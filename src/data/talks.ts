...
/**
 * Real talks only — add more entries here as they're confirmed.
 * Do not add placeholder/fictional talks.
 */
export const talks: Talk[] = [
  ...
  },
  {
    ...
    resources: [
      {
        name: 'Slides [EN]',
        url: 'https://slides.com/manucastrillonm/tech-communities'
      }
    ]
  },
  {
    ...
    resources: [
      {
        name: 'Slides [ES]',
        url: 'https://slides.com/manucastrillonm/sass-pioneras'
      }
    ]
  },
  {
    ...
    resources: [
      {
        name: 'Slides [EN]',
        url: 'https://slides.com/manucastrillonm/ngrx#/'
      }
    ]
  },
  {
  ...
  },
  {
    ...
    resources: [
      {
        name: 'Slides [ES]',
        url: 'https://slides.com/manucastrillonm/ionic-pioneras#/'
      }
    ]
  }
];

/** All talks sorted newest first, without mutating the source array. */
export const sortedTalks: Talk[] = [...talks].sort(
